	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container">
				...
				<div class="comment-status-text" id="comment-<?php comment_ID(); ?>">
					...
					<?php if ($comment->comment_approved == '0') { ?>
						<p class='comment-unapproved'><?php esc_html_e('Comentário aguardando a moderação.', 'zozothemes'); ?></p>
					<?php } ?>
					...
					<div class="reply">
						<span class="edit"><i class="fa fa-edit"></i><?php edit_comment_link( esc_html__('Editar', 'zozothemes'), '', ''); ?></span>	
						<span class="reply-link"><i class="fa fa-comments"></i><?php comment_reply_link(array_merge( $args, array('reply_text' => esc_html__('Responder', 'zozothemes'), 'depth' => $depth, 'max_depth' => $args['max_depth']))) ?></span>
					</div>
