			...
			<div class="entry-summary clearfix">
				<div class="entry-quotes quote-format">
					...
					<?php wp_link_pages( array(
							'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Páginas:', 'zozothemes' ) . '</span>',
							'after'       => '</div>',
							'link_before' => '<span>',
							'link_after'  => '</span>',
						) );
			...
			<div class="entry-meta-wrapper">
				<ul class="entry-meta">
					...
					<?php if ( is_sticky() && is_home() && ! is_paged() ) { ?>
						<li class="sticky-post"><i class="fa fa-thumb-tack"></i> <span class="meta-name"><?php esc_html_e('Destaque', 'zozothemes'); ?></span></li>						
					<?php } ?>
					<!-- Entry Author -->
					...
					<?php if( ! $zozo_options['zozo_blog_post_meta_comments'] ): ?>
						<?php if ( comments_open() ) { ?>
							<li class="comments-link"><i class="fa fa-comments"></i><?php comments_popup_link( '<span class="leave-reply">' . esc_html__( 'Nenhum Comentário', 'zozothemes' ) . '</span>', esc_html__( '1 Comentário', 'zozothemes' ), esc_html__( '% Comentários', 'zozothemes' ) ); ?>
						</li>
						<?php }
					endif; ?>
				</ul>
				...
				<div class="entry-footer clearfix">
					<div class="read-more">
						...
						<?php if( ! $zozo_options['zozo_blog_read_more_text'] ) { 
							esc_html_e('Leia mais', 'zozothemes'); 
						} else { 
